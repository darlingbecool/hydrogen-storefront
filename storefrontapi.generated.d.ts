...
export type GiftCardQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;
...
export type ResinVariantsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type ResinVariantsQuery = {
  product?: StorefrontAPI.Maybe<{
    variants: {
      nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GiftCard($handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      description\n      handle\n      featuredImage {\n        id\n        url\n        altText\n        width\n        height\n      }\n      variants(first: 10) {\n        nodes {\n          id\n          title\n          price {\n            amount\n            currencyCode\n          }\n          availableForSale\n        }\n      }\n    }\n  }\n': {
    ...
    variables: GiftCardQueryVariables;
  };
  ...
  '#graphql\n  query ResinVariants(\n    $country: CountryCode\n    $language: LanguageCode\n    $handle: String!\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      variants(first: 30) {\n        nodes {\n          id\n          availableForSale\n          selectedOptions { name value }\n        }\n      }\n    }\n  }\n': {
    return: ResinVariantsQuery;
    variables: ResinVariantsQueryVariables;
  };
